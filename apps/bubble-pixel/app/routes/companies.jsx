import { Card, GlobalPage, Grid, Icon, ListCompany, ListProfessor } from "@planingo/design-system";
...
export default function Index() {
  ...
  const {account, company} = useLoaderData()
  ...
  return (
    <div>
      ...
      >
        {isGrid ? <Grid>{company.map(p => <Card key={p.id} title={`${p.name}`} />)}</Grid> :
