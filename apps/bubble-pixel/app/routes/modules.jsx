import { Card, GlobalPage, Grid, Icon, ListModule, ListProfessor } from "@planingo/design-system";
...
export default function Index() {
  ...
  return (
    <div>
      ...
      >
        {isGrid ? <Grid>{module.map(p => <Card key={p.id} title={`${p.name}`} />)}</Grid> :
            <ListModule data={module}/>
        }
      </GlobalPage>
    </div>
  );
