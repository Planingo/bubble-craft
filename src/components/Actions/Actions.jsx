...
export const Actions = ({
  ...
  return (
    <div className="actions">
      ...
      >
        <DownloadOutlined
          className={`download ${disabledDownload ? "disabled" : "to-click"}`}
          onClick={downloadTitleOnClick}
        />
      </Tooltip>
      <Tooltip
        title={
          formatMessage({ id: cloudTitle.id }, { values: cloudTitle.values }) ||
          formatMessage({ id: "send" })
        }
        placement="bottom"
      >
        <CloudUploadOutlined
          className={`cloud ${disabledSend ? "disabled" : "to-click"}`}
        />
      </Tooltip>
      <Tooltip
        title={
